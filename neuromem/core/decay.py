...
class DecayEngine:
    ...
    def should_forget(self, item: MemoryItem, threshold: float = 0.1) -> bool:
        """
    ...
    def apply_decay(
        self, items: List[MemoryItem], forget_threshold: float = 0.1
    ...
    def schedule_consolidation(
        self, episodic_items: List[MemoryItem], days_threshold: float = 0
    ) -> List[MemoryItem]:
        """
